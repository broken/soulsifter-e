...
namespace soulsifter {
  ...
  SoulSifterSettings::SoulSifterSettings() {
    ...
    //ptree.put("dir.stems", "");
    //ptree.put("dir.vdjStems", "");
    //ptree.put("dir.vdjStemWaveforms", "");
    ...
    ptree.put("hotkey.nav.forward", "ArrowRight");
    ptree.put("hotkey.songList.up", "ArrowUp");
    ptree.put("hotkey.songList.down", "ArrowDown");
    ptree.put("hotkey.songList.select", "");
    ptree.put("hotkey.waveform.zoomIn", "Period");
    ptree.put("hotkey.waveform.zoomOut", "Comma");
